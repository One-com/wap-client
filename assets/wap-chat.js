...
(function () {
    ...
    function buildUI() {
        ...
        // skipped. The <select> is not just UI: renderAgentOptions() reads
        // selectedAgentRole off it (which loadQuota and every stream call send as
        // agent_role), and the proactive-handoff path resolves both the source
        // name and the switch target out of agentSelectEl.options. Dropping the
        // element would break handoff for any product that hides the picker.
        ...
        // Left out of the DOM rather than appended-and-hidden: a hidden <select>
        // is still a tab stop in some engines.
