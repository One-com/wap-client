...
export interface WapLayoutOptions {
    ...
    /**
     * false removes the composer's agent picker. Default true.
     *
     * Presentation only. The agent list is still fetched, so the default agent
     * and proactive handoff keep working — and premium gating stays enforced
     * server-side, never by this flag.
     */
