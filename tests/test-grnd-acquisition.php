...
// WP core returns status 501 (not 401) for both disabled cases — see
...
// as_error() is documented WP_Error|null — an error response without one must
// not fatal (AC5: no uncaught error in any case).
